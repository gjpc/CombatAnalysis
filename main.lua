...
Turbine.Shell.WriteLine("Combat Analysis v"..versionNo.." by Evendale enhanced by Landal"..(locale ~= "en" and L.TranslatedBy ~= nil and L.TranslatedBy ~= "" and " ("..L.TranslatedBy..")" or ""));
