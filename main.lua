...
Turbine.Shell.WriteLine("Combat Analysis by Evendale"..(locale ~= "en" and L.TranslatedBy ~= nil and L.TranslatedBy ~= "" and " ("..L.TranslatedBy..")" or ""));
Turbine.Shell.WriteLine("Combat Analysis v"..versionNo.." by Ravdor/Bamor"..(locale ~= "en" and L.TranslatedBy ~= nil and L.TranslatedBy ~= "" and " ("..L.TranslatedBy..")" or ""));
